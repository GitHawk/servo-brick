...
// Sets default velocity to 20 deg/s => full dim in ~5 sec
#define SERVO_VELOCITY_ORIG 0x0014
#define SERVO_ACCELERATION_ORIG 0xFFFF

// Sets the default frequency
#define SERVO_STARTUP_PERIOD_LENGTH 1000000 // in ns
#define SERVO_STARTUP_PERIOD (1000000/(SERVO_STARTUP_PERIOD_LENGTH/1000))
// Sets default pulse width to 1000 us = 1 ms
#define SERVO_STARTUP_POSITION      1000  // in us
#define SERVO_STARTUP_MAX_PULSE_WIDTH	1000000
// Sets default min pulse width to 1000 us = 1 ms
#define SERVO_STARTUP_MIN_PULSE_WIDTH	1000
// Sets default max angle to 100
#define SERVO_STARTUP_MAX_DEGREE	100
// Sets default min angle to 0
#define SERVO_STARTUP_MIN_DEGREE	0
